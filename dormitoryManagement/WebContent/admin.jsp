	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-2">
				...
				<a href="#" class="list-group-item active"><span class=""><i
				...
				</a> <a href="/dor/adminLeft/adminLeftStu.jsp" class="list-group-item">
					<span class="" aria-hidden="true"><i
						class="fa fa-user-circle fa-fw"></i> </span>学生信息
				</a> <a href="/dor/adminLeft/adminLeftDorInfo.jsp"
			...
			<div class="col-sm-10">
				...
				<script>
					...
					var pieConfig = {
						...
						data : {
							datasets : [ {
								data : [ <%=WaterAndElectricityFareDao.readCount(1)%>, <%=WaterAndElectricityFareDao.readCount(0)%>],
