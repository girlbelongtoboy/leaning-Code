...
<div class="container">
        <div class="form row">
            <form class="form-horizontal col-md-offset-3" id="login_form" action="<%= request.getContextPath()%>/servlet/LoginServlet" method="get">
                    ...
                    <!--   <div class="form-group" >
                     ...
                     <div class="form-group">
                      		<label class="radio-inline">
                            	<input type="radio" name="status" id="inlineRadio1" value="admin" class="radio-inline" checked="checked"> 管理员
                       		</label>
                        	<label class="radio-inline">
